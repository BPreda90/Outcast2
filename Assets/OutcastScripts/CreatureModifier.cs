...
public abstract class CreatureModifier
{
    ...
    public CreatureModifier(int modifierAgility, int modifierArkaneNnowledge, int modifierCurrentHealth, int modifierDamageReduction,
...
public class Trait : CreatureModifier
{
...
public class Item : CreatureModifier
{
    public string Name
    {
        get
